# SCSS to QSS Compiler Tests

## Basic SCSS Compilation

Compiles SCSS files to QSS (Qt stylesheets).
...
Resolves `@import` statements from one or more search paths.
...
Raises appropriate errors for missing files or SCSS syntax errors.
