...
class TestMainWindow:
    ...
    def test_window_has_sidebar(self, main_window: ForcWindow, qt: QtDriver) -> None:
        ...
        assert_that(main_window._sidebar).is_not_none()

    def test_window_has_menus(self, main_window: ForcWindow, qt: QtDriver) -> None:
        """Window should have file and view menus."""
        assert_that(main_window._file_menu).is_not_none()
        assert_that(main_window._view_menu).is_not_none()
...
class TestSidebar:
    ...
    def test_sidebar_shows_workspace_name(self, main_window: ForcWindow, workspace: Workspace, qt: QtDriver) -> None:
        ...
        collections_widget = sidebar._collections
        header_text = collections_widget._header.text()
    ...
    def test_sidebar_has_collections_tree(self, main_window: ForcWindow, qt: QtDriver) -> None:
        ...
        sidebar = main_window._sidebar.widget
        assert_that(sidebar._collections).is_not_none()
        assert_that(sidebar._collections._treeview).is_not_none()
