...
from forc.services import EnvironmentsService, HttpClientService
...
class ForcApp(App):
    ...
    # workspace_service: Variable[OldWorkspaceService] = new(environments=environments_service)
    ...
    def __setup__(self) -> None:
        ...
        #     print(f"Loading last workspace from path '{last_workspace_path}'.")
        #     self.workspace_service().load_workspace(Path(last_workspace_path))
        #     workspace = self.workspace_service().workspace()
        #     if workspace is not None:
        #         print(f"Workspace '{workspace.name}' loaded.")
    ...
    def _on_load_workspace(self, workspace_path: str) -> None:
        ...
        # workspace = self.workspace_service().load_workspace(Path(workspace_path))
